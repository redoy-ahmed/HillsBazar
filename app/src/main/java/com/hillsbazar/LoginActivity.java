    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(view -> {
            ...
            if (validateUsername(email) && validatePassword(pass)) { //Username and Password Validation
                ...
                if (email.equals("demo@gmail.com") && pass.equals("demo")) {

                    String sessionname = "Demo User";
                    sessionmobile = "01515607169";
                    String sessionemail = "demo@gmail.com";
                    String sessionphoto = String.valueOf(R.drawable.profile);
